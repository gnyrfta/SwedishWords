...
import javax.swing.border.SoftBevelBorder;
  ...
  final int bufSize = 16384;  
    ...
    private void shutDown(String message) {
      ...
      if (thread != null) {
        thread = null;
        MainWindowPronounce.captB.setEnabled(true);
      }
    }
    ...
    public void run() {
      ...
      if (MainWindowPronounce.audioInputStream == null) {
      ...
      AudioInputStream playbackInputStream = AudioSystem.getAudioInputStream(format,
          MainWindowPronounce.audioInputStream);

      if (playbackInputStream == null) {
        shutDown("Unable to convert stream of format " + MainWindowPronounce.audioInputStream + " to format " + format);
        return;
      }
